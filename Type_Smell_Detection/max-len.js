                ...
                if (commentLengthApplies) {
                    if (lineLength > maxCommentLength) {
                        context.report({
                            ...
                            message: "Line {{lineNumber}} of length ({{lineLength}}) exceeds the maximum comment line length of ({{maxCommentLength}}).",
                            data: {
                                lineLength,
                                lineNumber: i + 1,
                                maxCommentLength
                    ...
                    context.report({
                        node,
                        loc: { line: lineNumber, column: 0 },
                        message: "Line {{lineNumber}} of length ({{lineLength}}) exceeds the maximum line length of {{maxLength}}.",
                        data: {
                            lineLength,
                            lineNumber: i + 1,
                            maxLength
